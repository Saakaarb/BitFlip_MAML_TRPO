...
if __name__ == '__main__':
    ...
    evaluation.add_argument('--meta-batch-size', type=int, default=16, help='number of tasks per batch (default: 40)')
    # Miscellaneous
    misc = parser.add_argument_group('Miscellaneous')
    misc.add_argument('--output', type=str, default="output", help='name of the output folder (default: maml)')
    misc.add_argument('--seed', type=int, default=5, help='random seed (default: 1)')
    misc.add_argument('--num-workers', type=int, default=1, help='number of workers for trajectories sampling (default: {0})'.format(mp.cpu_count() - 1))
