...
class BitFlipEnv(gym.Env):
    ...
    def step(self, action):
        ...
        #    print("Solved in,reward,goal_states", self.steps,reward,self.goal_vector)
            pass

        # return state as numpy arrays
        # return goal_vector in info field
        return np.copy(self.state_vector), reward, done, {'goal':self.goal_vector}

    def sample_tasks(self,num_tasks):
        goals=np.random.randint(0, 2, size=(num_tasks,self.num_bits))
        #print(num_tasks)
